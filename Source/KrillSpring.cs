...
namespace Celeste.Mod.ShrimpHelper.Entities
{
	...
	public class KrillSpring : Entity
	{
		...
		public KrillSpring(Vector2 pos, KrillOrientations ori, bool pcu) : base(pos)
		{
		...
		public KrillSpring(EntityData data, Vector2 offset) : this(data.Position + offset, (KrillOrientations)data.Int("orientation", 0), data.Bool("playerCanUse", true))
		{
